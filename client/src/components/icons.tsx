...
export function Gamepad2Icon(props: IconProps) {
  return (
    <svg {...defaults(props)}>
      ...
      <path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1.803 0 2.168-.863 3-3l1.332-2.667a2 2 0 0 1 1.79-1.105h1.757a2 2 0 0 1 1.789 1.105L16 16c.832 2.137 1.197 3 3 3a3 3 0 0 0 3-3c0-1.544-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z" />
    </svg>
  );
}
